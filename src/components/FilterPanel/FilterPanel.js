        ...
        <div className={s.container}>
            <form onSubmit={handleSubmit} className={s.form}>
                <div className={s.header_wrapper}>
                    <h2>Фильтр по характеристикам</h2>
                </div>
                <div className={s.info_wrapper}>
                    <section className={s.section}>
                        <label className={s.label}>Тип ТС</label>
                    ...
                    <section className={s.wraper_with_slider}>
                        <section className={s.section_with_slider}>
                            <label className={s.label}>Объем двигателя</label>
                            <div className={s.div_diapason}>
                                <section>
                                    <label className={s.label_diapason}>От</label>
                    ...
                    <section className={s.wraper_with_slider}>
                        <section className={s.section_with_slider}>
                            <label className={s.label}>Пробег</label>
                            <div className={s.div_diapason}>
                                <section>
                                    <label className={s.label_diapason}>От</label>
                    ...
                    <button className={s.submit_button} type="submit">Применить</button>
                </div>
            </form>
        </div>
    );
